...
def geturl(key_word):
	...
	#url = 'http://open.api.tianyancha.com/services/open/ic/baseinfo/2.0?name=大成食品（大连）有限公司'
	url = 'http://open.api.tianyancha.com/services/open/ic/baseinfo/2.0?name='+key_word
	try:
...
if __name__ == '__main__':
	key_word = '大成食品（大连）有限公司'
	returndata = geturl(key_word)
	print(returndata)
